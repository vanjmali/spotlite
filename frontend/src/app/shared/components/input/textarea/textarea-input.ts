...
export class TextareaInputComponent {
  public readonly labelSg = input<string>('Textarea', { alias: 'label' });
  ...
  public readonly rowsSg = input<number>(4, { alias: 'rows' });
  public readonly showCounterSg = input<boolean>(false, { alias: 'showCounter' });
